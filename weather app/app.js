...
const weather = (realdata) => {
    ...
    if (realdata.weather[0].main == 'Haze'||realdata.weather[0].main == 'Mist') {
        document.body.style.background="url(mist.jpg) no-repeat center center/cover";
    }

   else if( realdata.weather[0].main == 'Rain'||realdata.weather[0].main=='Drizzle') {
        document.body.style.background="url(rainy2.jpg) no-repeat center center/cover";
    }

   else if( realdata.weather[0].main == 'Snow') {
        document.body.style.background="url(snow.jpg) no-repeat center center/cover";
    }
  
    else if( realdata.weather[0].main == 'Clear') {
        document.body.style.background="url(sunny2.jpg) no-repeat center center/cover";
    }
    else if( realdata.weather[0].main == 'Clouds') {
        document.body.style.background="url(claudy.jpg) no-repeat center center/cover";
    }
...
// retn d of mnth
const getdate = () => {
    let newdate = new Date(); // return curd and t
